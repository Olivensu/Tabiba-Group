...
const Map = () => {
    return (
      <div>
        ...
        ></iframe>
        <div className='bg-[rgb(41,62,156)] p-10 py-24 grid grid-cols-1 gap-10 md:grid-cols-2'>
          <div className='flex '>
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-20 h-20  bg-accent text-white p-3 mr-16"
            >
              <path
                strokeLinecap="round"
          ...
          <div>
            <form class="flex items-center">
              ...
              <button className=" btn btn-accent font-bold py-8 ml-2">
