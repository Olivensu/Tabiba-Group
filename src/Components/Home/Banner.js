...
const Banner = () => {
    return (
        <div className='grid grid-cols-1 justify-items-center md:grid-cols-3 gap-10 my-24 m-10'>
            <div className='flex items-center w-[350px] md:w-[420px]  bg-sky-400 rounded-xl p-3 py-5'>
            ...
            <div className='flex items-center  w-[350px] md:w-[420px]  bg-red-400 rounded-xl p-3'>
            ...
            <div className='flex items-center  w-[350px] md:w-[420px]  bg-lime-400 rounded-xl p-3'>
                <img className='w-20 rounded-xl mr-5' src={tabiba} alt="" />
                <div>
