...
import author from '../../img/author-1.jpg'
    ...
    return (
      <div className="text-center my-32 py-24 m-10 bg-[#F0ECE5]">
        ...
        <div>
          <div
            id="default-carousel"
            className="relative w-full md:w-2/3 m-auto"
            data-carousel="slide"
          >
            <div class="relative h-[550px]  overflow-hidden rounded-lg ">
              ...
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <div className=" w-3/4 p-5 rounded shadow-xl bg-white absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                  ...
                  <img src={author} className='m-auto my-10' alt="" />
                  <p className='text-2xl font-bold my-5'>Nathan Felix</p>
                  <p  className='text-lg font-bold my-5'>CEO, High Rise Construction</p>
                  <div className='flex justify-center'>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="w-6 text-orange-600 h-6"
                    >
                      <path
                        fillRule="evenodd"
              ...
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <div className=" w-3/4 p-5 rounded shadow-xl bg-white absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                <p  className="text-xl font-bold">
                    The staff is amazing! Very helpful and considerate <br /> with a
                    sense of urgency &Loads ...
                  </p>
                  <img src={author2} className='m-auto my-10' alt="" />
                  <p className='text-2xl font-bold my-5'>Lillian Grace</p>
                  <p  className='text-lg font-bold my-5'>VP, Green Valley International</p>
                  <div className='flex justify-center'>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
